...
public class EnemyBulletActor extends Actor {
    private Body body;
    ...
    public EnemyBulletActor(EnemyBullet bullet, World world) {
        this.dir = bullet.getDir();
        damage = 10;
        flyTime = 3;
        isDestroy = false;
        destroyOnce = false;
        setBounds(bullet.getPos().x, bullet.getPos().y, ITEM_SIZE, ITEM_SIZE);
        createBody(world);
        sprite = new Sprite(new Texture(Gdx.files.internal("top-down-shooter-1/weapons/shoot/3.png")));
    ...
    private void createBody(World world) {
        ...
        filter.categoryBits = GameMasks.E_BULLET_C;
        filter.maskBits = GameMasks.E_BULLET_M;
